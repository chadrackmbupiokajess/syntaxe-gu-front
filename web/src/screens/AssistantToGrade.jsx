                          ...
                          <div>
                            ...
                            {submissionItems.length > 0 && (
                              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                {submissionItems[0].department || 'N/A'} • {submissionItems[0].auditorium || 'N/A'}
                              </p>
                            )}
                          </div>
                                  ...
                                  return (
                                    <tr key={s.id} className="border-t border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                      ...
                                      <td className="py-2.5 px-4 text-right">
                                        <Link to={submissionUrl} className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
                                          Corriger
                                        </Link>
                                      </td>
                                    </tr>
